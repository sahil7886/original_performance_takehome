...
- **1490 cycles**: Claude Opus 4.5 in a casual Claude Code session, approximately matching the best human performance in 2 hours
- **1379 cycles**: Claude Opus 4.5 after 2 hours in our test-time compute harness
- **1348 cycles**: Claude Sonnet 4.5 after many more than 2 hours of test-time compute
- **1287 cycles**: Claude Opus 4.5 after 11.5 hours in the harness
